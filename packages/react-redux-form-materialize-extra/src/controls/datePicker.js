...
import { getErrors, getIconColor, getLabelClassName } from 'react-redux-form-materialize';
  ...
  render() {
    ...
    return (
      <div className={fieldClassName} onClick={this.onCalendarClick}>
        {PrefixIcon &&
        <PrefixIcon className="prefix" color={iconColor} onClick={this.onShow}/>
        }
        <input type="text" value={inputValue} readOnly={true} className={inputClassName} disabled={disabled}
               onClick={this.onShow}/>
